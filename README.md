...
则表中a<sub>i-1</sub>领先于a<sub>i</sub>，a<sub>i</sub>领先于a<sub>i+1</sub>，称a<sub>i-1</sub>是a<sub>i</sub>的直接前驱元素，a<sub>i+1</sub>是a<sub>i</sub>的直接后继元素。  
当i=1,2...，n-1时，a<sub>i</sub>有且仅有一个直接后继。  
当i=2,3...，n  时，a<sub>i</sub>有且仅有一个直接前驱。
